...
//
// PORT NOTE:
// - Ported from   : Lantern Designer 30__System__DrawingEditorMode/VghLantern__DrawingEditor__SheetManager__.js (BindSheetNavigation region)
// - Ported on     : 10-Sep-2026 for ValeVision3D v2.21.0 (port Phase 5)
// - Parity        : adapted
// - Divergences   :
//   - Bindings come from the key map rather than being written into the handlers.
//   - Keyboard navigation actions added (shipped disabled, the bare arrow keys stay on the selection nudge).
//   - Pointer capture and the panning class match the ValeVision surface, not the LD host.
//   - The 3D viewport zoom wheel of 1.1.0, ported from TrueVision3D.
// - Back-port     : the key map idea is worth taking back to LD if its bindings ever need to move.
//
// -----------------------------------------------------------------------------
//
// DEVELOPMENT LOG:
...
// - Ported from TrueVision3D (Controls__Pc 1.1.0, v2.50.0).
//
