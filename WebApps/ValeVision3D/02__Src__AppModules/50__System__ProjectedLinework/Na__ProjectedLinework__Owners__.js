// =============================================================================
// VALEVISION3D - PROJECTED LINEWORK - SEGMENT OWNERS
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 50__System__ProjectedLinework/Na__ProjectedLinework__Owners__.js (1.0.0)
// - Ported on     : 13-Sep-2026 for ValeVision3D v2.30.0
// - Parity        : verbatim below the header
// - Divergences   : Console prefix and this header only.
    ...
    function Na__PlOwners__Attach(classes, byClass, keys) {
        ...
        for (let i = 0; i < Na__PlOwners__CLASSES.length; i++) {
            ...
            if (!owners || owners.length !== expected) {
                console.warn('[ValeVision3D ProjectedLinework] Owner tags for the ' + name + ' class are ' +
