...
//   of its own. Ported from TrueVision3D (its 1.2.0, adapted: no InsertSet -
//   see PORT NOTE).
//
...
// -----------------------------------------------------------------------------
    ...
    // HELPER FUNCTION | The Toast Shown When a Set Actually Lands (Paste, not Duplicate)
    // ------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // The clipboard is left holding whatever it held before.
    // ------------------------------------------------------------
    function Na__LeClip__DuplicateItems(sheet, items) {
        ...
        const pasted = Na__LeClip__PasteSet(sheet, null, true);
