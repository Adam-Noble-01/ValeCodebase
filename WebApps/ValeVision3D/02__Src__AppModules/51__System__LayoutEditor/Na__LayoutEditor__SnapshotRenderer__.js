...
//
// PORT NOTE:
// - Ported from   : ValeVision3D 43__System__FloorPlanViews/Na__FloorPlan__ModeController__.js and 46 (enter and exit sequences)
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    import { Na__FpCfg__GetCameraSetup } from '../43__System__FloorPlanViews/Na__FloorPlan__ConfigState__.js';
    import { Na__FpData__GetCutHeightMm, Na__FpData__GetViewDepthMm, Na__FpData__GetSavedView } from '../43__System__FloorPlanViews/Na__FloorPlan__ProjectJson__Data__.js';
    import { Na__ElevCfg__GetCameraSetup } from '../46__System__ElevationViews/Na__Elevation__ConfigState__.js';
    import {
