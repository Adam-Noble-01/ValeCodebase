...
// - A new shape takes the Vectors panel's dashed-edge default (dashOn / dash).
// - Ported from TrueVision3D (ShapeTool dashed edges).
//
...
//   Ported from TrueVision3D 12-Sep-2026, verbatim.
//
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    import { Na__LeCfg__GetShapeSetup, Na__LeCfg__GetSelectionSetup } from '../03__Core__Config/Na__LayoutEditor__ConfigState__.js';
    import {
