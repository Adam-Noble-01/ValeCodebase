// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SHEET LAYOUT
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : Lantern Designer 30__System__DrawingEditorMode/VghLantern__DrawingEditor__SheetPdfLayout__.js
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.21.0 (port Phase 5)
// - Parity        : adapted
// - Divergences   : no view grid, gutters or slot placement; free viewports; title block height by style.
// - Back-port     : none.
//
// -----------------------------------------------------------------------------
//
...
// - Ported from TrueVision3D (SheetLayout 1.2.0). SpecMargin imports
//   MarginRect, so the Layout Editor could not load without it.
//
