...
//   - Focus arbiter imported from 42__System__DrawingViewCore/Na__DrawView__MarkupFocus__.js under the Na__DrawFocus__ namespace.
...
// endregion -------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // @delegate: ../45__System__PlanDimensions/Na__PlanDimensions__Editor__.js
    // ------------------------------------------------------------
    import {
    ...
    // ------------------------------------------------------------
    // @delegate: ../45__System__PlanDimensions/Na__PlanDimensions__AxisLock__.js
    // @delegate: ../42__System__DrawingViewCore/Na__DrawView__MarkupFocus__.js
    // ------------------------------------------------------------
    import {
    ...
    import { Na__PlanDimGrid__AXIS_X } from '../45__System__PlanDimensions/Na__PlanDimensions__Grid__.js';
    import {
    ...
    import { Na__PlanDimEdit__GetSelectedRecord } from '../45__System__PlanDimensions/Na__PlanDimensions__Editor__.js';
    import { Na__PlanDimLayer__Sync } from '../45__System__PlanDimensions/Na__PlanDimensions__Overlay__.js';
    import {
        Na__DrawFocus__DIMENSIONS,
        Na__DrawFocus__CAP_DELETE,
        Na__DrawFocus__ShouldHandle
    } from '../42__System__DrawingViewCore/Na__DrawView__MarkupFocus__.js';
    // ------------------------------------------------------------
