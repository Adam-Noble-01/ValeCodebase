// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - VIEWPORT HANDLES
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : ValeVision3D 35__System__PageLayoutSystem/Na__PageLayoutSystem__Controls__Pc__.js (handle conventions)
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.21.0 (port Phase 5)
// - Parity        : adapted
// - Divergences   : millimetre space, two viewport kinds with different edge and corner behaviour.
// - Back-port     : none.
//
// -----------------------------------------------------------------------------
//
...
// - Ported from TrueVision3D (ViewportHandles 1.4.0, v2.50.0).
//
// 14-Sep-2026 - Version 1.3.0
// - Box select: RenderOutlines - an outline on each of several selected
//   viewports and no handles, for a multi-selection. Render and it share one
//   outline builder.
