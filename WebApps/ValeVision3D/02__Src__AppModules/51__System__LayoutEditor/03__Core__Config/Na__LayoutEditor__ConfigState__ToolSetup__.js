// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - CONFIG STATE - TOOL SETUP
// =============================================================================
//
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // fadeOpacity is how far back the rest of the sheet drops while a vector, a
    // dimension or a group is open for editing. moveToolRequired is the safety
    // catch: with it on, a whole object only travels under the Move tool, so a
    // stray drag with Select moves nothing at all.
    // ------------------------------------------------------------
