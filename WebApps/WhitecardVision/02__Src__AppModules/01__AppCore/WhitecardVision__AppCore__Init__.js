...
(function () {
    ...
    function Wv__AppCore__InstallGlobalHotkeys() {
        ...
        window.Wv__AppUtils__Hotkeys.Wv__Hotkeys__Register('ctrl+1', () => window.Wv__AppCore__ModeManager.Wv__ModeManager__SwitchToMode('Render'));
        window.Wv__AppUtils__Hotkeys.Wv__Hotkeys__Register('ctrl+2', () => window.Wv__AppCore__ModeManager.Wv__ModeManager__SwitchToMode('Editor'));
        window.Wv__AppUtils__Hotkeys.Wv__Hotkeys__Register('ctrl+3', () => window.Wv__AppCore__ModeManager.Wv__ModeManager__SwitchToMode('FilterSuite'));
        window.Wv__AppUtils__Hotkeys.Wv__Hotkeys__Register('ctrl+4', () => window.Wv__AppCore__ModeManager.Wv__ModeManager__SwitchToMode('FinalPreview'));
    }
    /* ------------------------------------------------------------ */
