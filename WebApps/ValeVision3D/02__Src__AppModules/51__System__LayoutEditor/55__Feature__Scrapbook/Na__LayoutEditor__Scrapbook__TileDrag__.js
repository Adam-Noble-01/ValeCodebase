// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SCRAPBOOK - TILE DRAG
// =============================================================================
//
...
// -----------------------------------------------------------------------------
    ...
    function Na__LeScrapDrag__Tile(spec) {
        ...
        let preview = null;
        try { preview = Na__LeScrap__PreviewSvg(spec.buildSet(), 'na-le-scrap__svg'); } catch (error) { console.warn('[ValeVision3D LayoutEditor] A scrapbook preview could not be drawn: ' + spec.id, error); }
