// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - PANEL: SCRAPBOOK
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 55__Feature__Scrapbook/Na__LayoutEditor__Panel__Scrapbook__.js,
//                   its 1.2.0 (TrueVision v2.85.0)
// - Ported on     : 20-Sep-2026 for ValeVision3D v2.68.0
// - Parity        : adapted
// - Divergences   : A config that cannot be read shows the section on every sheet to say so, where
//                   TrueVision shows it only on a site plan sheet: this app has no such sheets.
...
// -----------------------------------------------------------------------------
    ...
    function Na__LePanelScrap__Sync() {
        ...
        const show   = !!sheet && (Na__LeScrap__ItemsFor(sheet).length > 0 || failed);
