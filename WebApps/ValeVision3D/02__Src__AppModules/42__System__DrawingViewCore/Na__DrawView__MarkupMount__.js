// =============================================================================
// VALEVISION3D - DRAWING VIEW CORE - MARKUP MOUNT
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 02__Src__AppModules/40__System__DrawingViewCore/Na__DrawView__MarkupMount__.js
// - Source version: 1.0.0 (07-Sep-2026)
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.18.0 (port Phase 2)
// - Parity        : verbatim
// - Divergences   :
//   - Console prefix and app name read ValeVision3D.
//   - Import paths follow the ValeVision folder numbers (42 DrawingViewCore, 43 FloorPlanViews, 44 PlanAnnotations, 45 PlanDimensions).
//   - Dimension config getters imported from Na__PlanDimensions__ConfigState__.js (TrueVision keeps them in the data module).
...
// -----------------------------------------------------------------------------
    ...
    } from '../44__System__PlanAnnotations/Na__PlanAnnotations__Overlay__.js';
    import {
        Na__PlanAnnoEdit__Enable,
        Na__PlanAnnoEdit__Disable,
        Na__PlanAnnoEdit__AttachNode
    } from '../44__System__PlanAnnotations/Na__PlanAnnotations__Editor__.js';
    import {
        Na__PlanAnnoBar__Mount,
        Na__PlanAnnoBar__Unmount,
        Na__PlanAnnoBar__Refresh
    } from '../44__System__PlanAnnotations/Na__PlanAnnotations__Toolbar__.js';
    import {
        Na__PlanAnnoHist__Begin,
        Na__PlanAnnoHist__End
    } from '../44__System__PlanAnnotations/Na__PlanAnnotations__History__.js';
    import {
        Na__PlanAnnoKeys__Attach,
        Na__PlanAnnoKeys__Detach
    } from '../44__System__PlanAnnotations/Na__PlanAnnotations__Hotkeys__.js';
    // ------------------------------------------------------------
    ...
    } from '../45__System__PlanDimensions/Na__PlanDimensions__ConfigState__.js';
    import {
        Na__PlanDim__GetSessionDimensions,
        Na__PlanDim__SetAuthoringMode,
        Na__PlanDim__AUTHOR_DEV
    } from '../45__System__PlanDimensions/Na__PlanDimensions__Data__.js';
    import {
        Na__PlanDimLayer__Mount,
        Na__PlanDimLayer__Unmount,
        Na__PlanDimLayer__Sync,
        Na__PlanDimLayer__SyncLayerBox
    } from '../45__System__PlanDimensions/Na__PlanDimensions__Overlay__.js';
    import {
        Na__PlanDimEdit__Enable,
        Na__PlanDimEdit__Disable,
        Na__PlanDimEdit__AttachNode
    } from '../45__System__PlanDimensions/Na__PlanDimensions__Editor__.js';
    import {
        Na__PlanDimGrid__EstablishPlane,
        Na__PlanDimGrid__Dispose
    } from '../45__System__PlanDimensions/Na__PlanDimensions__Grid__.js';
    import {
        Na__PlanDimHist__Begin,
        Na__PlanDimHist__End
    } from '../45__System__PlanDimensions/Na__PlanDimensions__History__.js';
    import {
        Na__PlanDimKeys__Attach,
        Na__PlanDimKeys__Detach
    } from '../45__System__PlanDimensions/Na__PlanDimensions__Hotkeys__.js';
    import {
        Na__PlanDimAxis__Configure,
        Na__PlanDimAxis__Dispose
    } from '../45__System__PlanDimensions/Na__PlanDimensions__AxisLock__.js';
    import {
        Na__PlanDimVert__Sync,
        Na__PlanDimVert__Dispose
    } from '../45__System__PlanDimensions/Na__PlanDimensions__VertexEditor__.js';
    import {
    ...
    } from '../45__System__PlanDimensions/Na__PlanDimensions__ClientMode__.js';
    // ------------------------------------------------------------
