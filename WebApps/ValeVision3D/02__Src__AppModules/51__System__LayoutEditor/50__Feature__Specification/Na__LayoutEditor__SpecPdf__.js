...
// the same primitives the sheets are drawn with, in the face its own measurer
// uses, and the words in the file are words.
//
...
//                   core is 42__System__DrawingViewCore here.
...
// - Ported from TrueVision3D: Download on the Project Specification bar.
//
// =============================================================================
...
// -----------------------------------------------------------------------------
    ...
    async function Na__LeSpecPdf__BuildDocument() {
        const JsPdf = await Na__LePdf__EnsureJsPdf();                               // <-- jsPDF injected if it is not there yet
