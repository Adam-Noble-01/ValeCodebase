// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - PARAMETRIC SCRAPBOOK
// =============================================================================
//
        ...
        if (!Na__LeParam__LoadPromise) {
            Na__LeParam__LoadPromise = (async () => {
                try {
                    ...
                    console.warn('[ValeVision3D LayoutEditor] Parametric Scrapbook config unavailable - it has no elements.', error);
