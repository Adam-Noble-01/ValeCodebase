...
//   export list is the API, and Na__LayoutEditor__Loader__ imports this file
//   by name. The units import one way only (State, then Document, then Draft,
//   then Editing and Transport); this file imports all five, and no unit
//   imports it.
//
// -----------------------------------------------------------------------------
//
...
// - Split         : 15-Sep-2026 for ValeVision3D v2.47.0, into the five units
//                   above. The same split applies to TrueVision's copy.
//
// -----------------------------------------------------------------------------
//
// DEVELOPMENT LOG:
...
//   CanReloadCloud and CanReloadLocal (Transport 1.1.0; ported from
//   TrueVision3D).
//
