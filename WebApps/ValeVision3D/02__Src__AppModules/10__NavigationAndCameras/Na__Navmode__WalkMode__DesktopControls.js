// =============================================================================
// VALEVISION3D - WALK MODE DESKTOP CONTROLS
// =============================================================================
//
...
// -----------------------------------------------------------------------------
    ...
    // closes. Safe to call whether or not walk mode is currently active, and
...
// -----------------------------------------------------------------------------
    ...
    function Na__WalkModeDesktop__Activate(domElement, config) {
        ...
        // Entering walk with a panel already open must not snatch the pointer
