// =============================================================================
// VALEVISION3D - WALK MODE PROXIMITY DOOR ANIMATION TRIGGER
// =============================================================================
//
...
// -----------------------------------------------------------------------------
    ...
    const Na__DoorProximity__MOD_TYPE_FIXED                = 'FIXED';    // <-- Static panel
    // ------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    function Na__DoorProximity__FindNearestPanel(doorRecord, capsulePositionUnits) {
        ...
        doorRecord.panels.forEach((panel) => {
            ...
            const distance = Na__DoorProximity__CalculatePlanarDistance(
