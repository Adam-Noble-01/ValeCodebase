// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SHEET CHROME
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : Lantern Designer 30__System__DrawingEditorMode/VghLantern__DrawingEditor__SheetChrome__.js
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.21.0 (port Phase 5)
// - Parity        : adapted
// - Divergences   : polyline, rotated text and clipped groups added for dimensions and viewport contents; QR and terms cells not carried; title blocks in their own modules.
// - Back-port     : none.
//
// -----------------------------------------------------------------------------
//
...
//   keeps using.
// - Ported from TrueVision3D (SheetChrome 1.5.0).
//
...
// -----------------------------------------------------------------------------
    ...
    import { Na__LeScale__FormatLabel } from '../07__Core__SheetData/Na__LayoutEditor__ScaleManager__.js';
    import { Na__LeModel__ResolveViewportSource, Na__LeModel__IsLayerVisible, Na__LeModel__KIND_2D } from '../07__Core__SheetData/Na__LayoutEditor__SheetModel__.js';
...
// -----------------------------------------------------------------------------
    ...
    function Na__LeChrome__DrawToPdf(doc, primitives) {
        ...
        primitives.forEach((primitive) => {
            ...
            catch (drawError) { console.warn('[ValeVision3D LayoutEditor] Primitive could not be drawn:', primitive.Kind, drawError); }
        });
    }
    // ------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    function Na__LeChrome__LoadAsset(path) {
        ...
        const loading = fetch(path).then((response) => {
            ...
            console.warn('[ValeVision3D LayoutEditor] Asset unavailable: ' + path, assetError);
