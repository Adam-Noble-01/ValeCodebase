// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - RASTER QUALITY
// =============================================================================
//
...
// PORT NOTE:
// - Ported from   : none
// - Ported on     : 10-Sep-2026 for ValeVision3D v2.21.9 (port Phase 5)
// - Parity        : new
// - Divergences   : n/a
// - Back-port     : none.
//
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    import { Na__LeCfg__GetRasterSetup } from '../03__Core__Config/Na__LayoutEditor__ConfigState__.js';
    // ------------------------------------------------------------
