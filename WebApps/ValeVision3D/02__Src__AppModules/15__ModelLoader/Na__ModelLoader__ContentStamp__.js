// =============================================================================
// VALEVISION3D - MODEL LOADER - CONTENT STAMP
// =============================================================================
//
...
//   Until v2.57.0 that fingerprint was each category's NAME and TRIANGLE COUNT.
//   Move something along a wall and re-export: same names, same counts, same
//   fingerprint, and every cache hands back the drawing of it where it used
//   to be.
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 15__ModelLoader/Na__ModelLoader__ContentStamp__.js 1.0.0
// - Ported on     : 18-Sep-2026 for ValeVision3D v2.57.0 (from TrueVision3D v2.64.1)
// - Parity        : verbatim
...
// - Initial implementation. Ported from TrueVision3D 1.0.0 (v2.64.1).
//
// =============================================================================
