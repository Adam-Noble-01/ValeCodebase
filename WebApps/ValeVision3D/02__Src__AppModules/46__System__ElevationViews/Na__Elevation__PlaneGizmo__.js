// =============================================================================
// VALEVISION3D - ELEVATION VIEWS - PLANE GIZMO
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 02__Src__AppModules/45__System__ElevationViews/Na__Elevation__PlaneGizmo__.js
...
//   - Additive GetFaceMesh export for the gizmo grip; helper objects also carry naCrossSectionHelper.
...
// -----------------------------------------------------------------------------
    ...
    function Na__ElevGizmo__MarkAsHelper(object) {
        ...
        object.userData.naCrossSectionHelper = true;                             // <-- Same flag the ValeVision Cross Sections tool honours
...
// -----------------------------------------------------------------------------
    ...
    // FUNCTION | The Translucent Plane Mesh (the grip raycasts against it)
    // ------------------------------------------------------------
    // ValeVision addition: Na__Elevation__GizmoGrip__ tests only this mesh, so
    // a press on the building behind it starts an orbit as usual.
    // ------------------------------------------------------------
