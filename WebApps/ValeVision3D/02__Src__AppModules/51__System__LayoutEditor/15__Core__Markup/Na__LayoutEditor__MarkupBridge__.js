...
//
// PORT NOTE:
// - Ported from   : ValeVision3D 44__System__PlanAnnotations and 45__System__PlanDimensions (record readers and drawing rules)
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.21.0 (port Phase 5)
// - Parity        : adapted
// - Divergences   : static scene markup in a viewport (editing stays in the drawing) instead of mounting the live engines on the sheet (plan 11.3); native sheet markup records.
// - Back-port     : none.
//
// -----------------------------------------------------------------------------
//
...
//   select (1.5.0) and assigned an undeclared highlight, so it never matched
//   the array the sheet passes and drew nothing. It now asks isChosen and
//   adds to highlights like every other item, as TrueVision's does.
//
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    import { Na__FpData__GetAnnotations } from '../../43__System__FloorPlanViews/Na__FloorPlan__ProjectJson__Data__.js';
    import { Na__ElevData__GetAnnotations, Na__ElevData__GetDimensions } from '../../46__System__ElevationViews/Na__Elevation__ProjectJson__Data__.js';
    import { Na__PlanAnno__ReadAll, Na__PlanAnno__Read, Na__PlanAnno__GetTextSetup } from '../../44__System__PlanAnnotations/Na__PlanAnnotations__Data__.js';
    import {
    ...
    import { Na__PlanDim__GetLineSetup, Na__PlanDim__GetTextSetup } from '../../45__System__PlanDimensions/Na__PlanDimensions__ConfigState__.js';
    // ------------------------------------------------------------
