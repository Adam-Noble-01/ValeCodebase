// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - ITEM CLIPBOARD
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 51__System__LayoutEditor/Na__LayoutEditor__ItemClipboard__.js 1.0.0
...
// -----------------------------------------------------------------------------
    ...
    import { Na__LeGroup__Expand, Na__LeGroup__ItemsBounds, Na__LeGroup__IsKind } from '../15__Core__Markup/Na__LayoutEditor__Groups__.js';
