# 22__Generated__UserMidiPatterns

**Empty on purpose. Nothing writes here yet.**

This folder is where patterns the user writes will live once AudioSPACE has a server behind it. It mirrors
`07__Data__MidiPatternLibrary`, which holds the shipped, version-controlled equivalent.
