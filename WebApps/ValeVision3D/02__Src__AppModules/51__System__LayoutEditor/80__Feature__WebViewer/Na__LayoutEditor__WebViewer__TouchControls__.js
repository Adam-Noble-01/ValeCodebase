// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - WEB VIEWER - TOUCH SCREEN CONTROLS
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 51__System__LayoutEditor/80__Feature__WebViewer/Na__LayoutEditor__WebViewer__TouchControls__.js
// - Ported on     : 18-Sep-2026 for ValeVision3D v2.65.0
// - Parity        : verbatim
// - Divergences   : Header and port note only.
