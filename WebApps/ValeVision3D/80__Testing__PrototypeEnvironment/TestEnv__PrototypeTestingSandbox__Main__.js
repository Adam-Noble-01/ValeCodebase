// =============================================================================
// VALEVISION3D - TEST ENVIRONMENT MAIN ENGINE BOOTSTRAP
// =============================================================================
//
...
// - Reuses all engine modules from the parent ValeVision3D project.
...
// -----------------------------------------------------------------------------
    ...
    function TestEnv__NodeExplorer__GenerateTreeText(object, depth = 0, isLast = true, prefix = '') {
        ...
        const visibleIcon = object.visible ? '👁' : '🚫';
    ...
    async function TestEnv__NodeExplorer__CopyTree() {
        let treeText = '# ValeVision3D - Node Graph Explorer\n';
...
// -----------------------------------------------------------------------------
    ...
    console.log('[TestEnv] ValeVision3D Test Environment initialized');
    // ------------------------------------------------------------
