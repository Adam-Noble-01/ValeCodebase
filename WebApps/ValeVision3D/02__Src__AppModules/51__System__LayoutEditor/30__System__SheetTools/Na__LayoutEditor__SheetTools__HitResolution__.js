// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SHEET TOOLS - HIT RESOLUTION
// =============================================================================
//
...
// PURPOSE    : What is under the pointer: the item a point resolves to, its record, lock and cursor, with the hit tolerance and the vector grab, insert and snap helpers
// CREATED    : 15-Sep-2026
//
// DESCRIPTION:
...
//   cursor for what is under the pointer.
...
//   dimension grip only a grip, inside its own container; outside, every press
...
// -----------------------------------------------------------------------------
    ...
    // MODULE IMPORTS | Config, Model, Surface, Handles, Markup, Grips, Shape Geometry, Groups, Snapping
    // ------------------------------------------------------------
    ...
    import { Na__LeShapeGeo__Points, Na__LeShapeGeo__ClosestOnEdge, Na__LeShapeGeo__VertexAt } from '../15__Core__Markup/Na__LayoutEditor__ShapeGeometry__.js';
    import {
