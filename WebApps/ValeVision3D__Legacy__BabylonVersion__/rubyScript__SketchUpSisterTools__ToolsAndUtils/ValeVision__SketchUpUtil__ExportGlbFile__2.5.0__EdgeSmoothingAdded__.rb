...
module GLBBuilderUtility
    ...
    # -----------------------------------------------------------------------------
        ...
        # ------------------------------------------------------------
        # NOTE: Functions below are for potential future use with vertex welding
        # Currently only edge filtering (soft+smooth edges excluded from line export) is implemented
        
            # HELPER FUNCTION | Check if Edge is Soft and Smooth (Currently Unused)
            # ---------------------------------------------------------------
            ...
            # FUNCTION | Build Soft+Smooth Edge Map from Active Entities (Currently Unused)
            # ---------------------------------------------------------------
