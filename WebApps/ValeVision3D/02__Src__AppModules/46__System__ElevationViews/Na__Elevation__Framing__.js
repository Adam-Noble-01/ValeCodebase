// =============================================================================
// VALEVISION3D - ELEVATION VIEWS - MODEL FRAMING
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 02__Src__AppModules/45__System__ElevationViews/Na__Elevation__Framing__.js
...
//   - The synthetic approach scene carries PresentationMode__Scene__IsDrawingApproach so the cross section scene data skips it.
...
// -----------------------------------------------------------------------------
    ...
    function Na__ElevFrame__BuildApproachScene(elevation, measurement, fovDegrees, durationMs, easing) {
        ...
        return {
            ...
            PresentationMode__Scene__IsDrawingApproach           : true,        // <-- Cross section scene data must not clear the drawing cut
