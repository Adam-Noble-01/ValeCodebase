    ...
    ::;mdfileheading::
        {
            ...
            markdown_header := ""
            . "# Enter_Title_Here`r`n"
            . "<div class=""h1__Strapline""> `r`n"
            . "Enter_Strapline_/_Subtitle_Here - Started " . TodayDate . "`r`n"
            . "</div>"
...
::;rbconsoleclear::
::;rbclearconsole::
::;rubyclearrubyconsole::
{
    ruby_clear_console_code := ""
        . "def clear_console`r`n"
        . "    puts ""`n"" * 100`r`n"
        . "end`r`n"
        . "`r`n"
        . "clear_console"
    ...
    ClipboardOld := ClipboardAll
    Clipboard := ruby_clear_console_code
    ClipWait, 0.2
    SendInput, ^v
    Sleep, 50
    Clipboard := ClipboardOld
...
; region | - - - - - - - - - - - - - - - |  Python Script Powershell Execution  | - - - - - - - - - - - - - - - -  - - - - |
    ...
    ; - - Command Logic - - 
        Clipboard := "Python D:\10_CoreLib__ValeCodebase\Root_GeneralDeveloperTools\02_Python\SnPy_PdfToPngConverter\SnPy_PdfToPngConverter.py"   ; <-- This sets the text appended to the clipboard.
...
; region | - - - - - - - - - - - - - - - |  Python Script Powershell Execution  | - - - - - - - - - - - - - - - -  - - - - |
    ...
    ; - - Command Logic - - 
        Clipboard := "Python D:\10_CoreLib__ValeCodebase\Root_GeneralDeveloperTools\02_Python\SnPy_PngToPdfConverter\SnPy_PngToPdfConverter.py"  ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                 				 ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                       				 ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; | - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - |
    ...
    ; - - Command Logic - - 
        Clipboard := "Python D:\10_CoreLib__ValeCodebase\Root_GeneralDeveloperTools\02_Python\SnPy_PdfDocCompiler\SnPy_PdfDocCompiler.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                                       ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                                             ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
    ...
    ::;template - sketchup::
        {
            ...
            sketchup_script := ""
            . "$sourcePath = ""D:\02_CoreLib__SketchUp\06_-_Core-Lib_-_SketchUp-Templates\SketchUp__MasterTemplate__Active.skp""`r`n"
