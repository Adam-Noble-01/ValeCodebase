// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SPECIFICATION DOCUMENT
// =============================================================================
//
...
//
// PORT NOTE:
// - Authored in   : TrueVision3D first (14-Sep-2026, v2.51.0)
...
// - Ported from TrueVision3D v2.51.0.
//
// =============================================================================
...
// -----------------------------------------------------------------------------
    ...
    // MODULE IMPORTS | Config, Specification, Project Code and Folder Id
    // ------------------------------------------------------------
    import {
        Na__LeCfg__GetLabel,
    ...
    import { Na__AppUtils__NormalizeProjectFolderId } from '../../03__AppUtils/Na__AppUtils__ProjectLoader.js';
    // ------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // The name is the part of the project's folder id after its code
    // ("2026/3047__Doous" reads "Doous"), the way the share-link emails name a
    // project, with run-together words parted ("WestFarm" reads "West Farm").
    ...
    function Na__LeSpecDoc__Project() {
        ...
        const name   = folder.split('__').slice(1).join(' ').replace(/[_-]+/g, ' ').replace(/([a-z0-9])([A-Z])/g, '$1 $2').replace(/\s+/g, ' ').trim();
        return {
            code    : code,
