// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - PANEL: CUSTOM SCRAPBOOK
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 56__Feature__ScrapbookCustom/Na__LayoutEditor__Panel__ScrapbookCustom__.js,
//                   its 1.0.0 (TrueVision v2.85.0)
// - Ported on     : 20-Sep-2026 for ValeVision3D v2.69.0
// - Parity        : verbatim in every code region but two fallback strings, which name this app's server
    ...
    function Na__LePanelScrapCustom__SaveState(categoryName) {
        ...
        if (!Na__LeScrapCustom__IsWritable()) {
            ...
            return { can : false, warn : true, text : restart
                ? L('SaveRestart', 'The local development server is running without the scrapbook routes. Restart it, then save.')
                : L('SaveNoServer', 'Saving needs the local development server. This library is read-only here.') };
        }
