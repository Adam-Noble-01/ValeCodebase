// =============================================================================
// VALEVISION3D - PROJECTED LINEWORK - SOUP BUILDER
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : Lantern Designer 02__Src__AppModules/27__System__ProjectedEdges2d/VghLantern__ProjectedEdges__SoupBuilder__.mjs
// - Source version: Lantern Designer rebuild of 07-Aug-2026
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.20.0 (port Phase 4)
// - Parity        : adapted
// - Divergences   :
//   - ViewMapFromBasis returns either a signed-permutation map or a 3x3 rotation, and BuildViewSoup takes both (D40).
//   - The permutation path is the Lantern Designer's arithmetic unchanged.
// - Back-port     : the rotation path, should the Lantern Designer ever want a free-bearing view.
//
// -----------------------------------------------------------------------------
//
// DEVELOPMENT LOG:
