...
import { Na__AppCore__GetState, Na__AppCore__InitializeStateStore, Na__AppCore__SetState, Na__AppCore__SetWorkers, Na__AppCore__SubscribeStateChange } from './Na__AppCore__StateStore.js';
...
// -----------------------------------------------------------------------------
 ...
 // ------------------------------------------------------------
 export function Na__AppCore__InitializeValePlannerApp(rootElement) {
     ...
     Na__AppCore__InitializeStateStore({
         workers: structuredClone(workersSeedData.workers),
         defaultWorkers: structuredClone(workersSeedData.workers),
         mainTab: 'schedule',
         viewMode: 'week',
     ...
     Na__AppCore__SubscribeStateChange(() => {
