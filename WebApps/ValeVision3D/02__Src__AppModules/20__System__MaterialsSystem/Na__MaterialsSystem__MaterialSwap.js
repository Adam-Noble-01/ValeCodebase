// =============================================================================
// VALEVISION3D - MATERIALS SYSTEM - MATERIAL SWAP
// =============================================================================
//
...
// -----------------------------------------------------------------------------
    ...
    function Na__MaterialsSystem__ApplyMirrorEnvironmentOverrides(modelGroup, envMapTexture, options = {}) {
        ...
        const processedMaterials = new Set();                                 // <-- Ensures each material instance is only darkened once, even when shared across many meshes
