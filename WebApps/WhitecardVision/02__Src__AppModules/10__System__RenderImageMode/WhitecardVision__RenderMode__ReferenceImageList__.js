...
=============================================================================
 Handles Material + Style reference tiles. Enforces the combined cap
 (Material + Style <= 10) using the RenderMode config JSON.
============================================================================= */
...
(function () {
    ...
    function Wv__RenderMode__ReferenceImageList__BuildTile(refEntry, referenceTypeToken, tileIndex) {
        ...
        thumbElement.addEventListener('click', async () => {
            try {
