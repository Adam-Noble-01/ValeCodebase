...
```json
{
    ...
    "valeVision_ModelUrl": "https://cdn.noble-architecture.com/VaApps/Projects/2025/VGH-2025-001__GardenHouseAlpha/Model__1.0.0__.glb",
    "images": [
        "view_01_front.jpg",
        "view_02_side.jpg",
        "view_03_rear.jpg",
...
## ValeVision 3D Model URL

Optional CDN URL(s) for ValeVision3D interactive model viewer:
- **valeVision_ModelUrl** - Cloudflare CDN URL to .glb model file(s)
- Can be a single URL string or array of URLs for multiple models
- Automatically generated by project builder script if .glb files exist
- Format: `https://cdn.noble-architecture.com/VaApps/Projects/2025/[ProjectFolder]/[ModelFile].glb`
- If null or omitted, ValeVision3D viewer will not be available for this project
- Models should be placed in `ValeVision__GlbFileSync` subfolder in source Whitecard projects

**Examples:**
```json
// Single model
"valeVision_ModelUrl": "https://cdn.noble-architecture.com/VaApps/Projects/2025/VE-61058__Staley/Model__1.0.0__.glb"

// Multiple models
"valeVision_ModelUrl": [
    "https://cdn.noble-architecture.com/VaApps/Projects/2025/VE-61058__Staley/Model__1.0.0__.glb",
    "https://cdn.noble-architecture.com/VaApps/Projects/2025/VE-61058__Staley/Model__2.0.0__.glb"
]

// No model available
"valeVision_ModelUrl": null
```
