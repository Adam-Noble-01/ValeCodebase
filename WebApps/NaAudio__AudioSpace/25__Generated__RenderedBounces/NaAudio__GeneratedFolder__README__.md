...
This folder is where audio bounced when a module locks will live once AudioSPACE has a server behind it. It mirrors
`(no shipped equivalent)`, which holds the shipped, version-controlled equivalent.
