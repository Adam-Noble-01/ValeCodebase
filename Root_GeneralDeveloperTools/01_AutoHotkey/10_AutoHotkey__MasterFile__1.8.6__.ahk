...
; =============================================================================
; GLOBAL CONSTANTS - PYTHON SCRIPTS ROOT DIRECTORY
; =============================================================================
; This is set globally as a constant at the very beginning to ensure it's 
; available throughout the entire script execution before any return statements
PYTHON_ROOT := "D:\10_CoreLib__ValeCodebase\Root_GeneralDeveloperTools\02_Python"
ClickCount := 0  ; Initialize click counter for triple-click functionality
; =============================================================================

; region  |  - - - - - - - - - - - - - - - - - - - - - - - - |  VERSION NOTES  | - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  |

    ; Version 1.0.0 | Re-formatted Script Consolidating older scripts into this new master script,
    ; Version 1.1.0 | Added date and time input hotstrings with calculation automation
    ...
    ; Version 1.5.8 | 02-May-2025 | Added Clean Path Copy hotkey, extending windows 11 path copy
    ; Version 1.5.9 | 09-May-2025 | Updated the temp folder path for Work Office PC, added some more Hotstrings for the shortcut
    ; Version 1.6.0 | 09-May-2025 | Added new Launch - PDF To PNG Converter Utility Python Script
    ; Version 1.6.1 | 22-May-2025 | Added Ruby Console Clear Hotstring
    ; Version 1.6.2 | 30-May-2025 | Added new Launch - PDF Document Compiler Utility Python Script
    ; Version 1.6.3 | 04-Jun-2025 | Add PowerShell Script to create typical folder structure for image processing projects.
    ;                               These are the folders are created in the current directory that powershell is run from.
    ;                                   PowerShell Add Folder  -  "01_-_Reference"      -  Then
    ;                                   PowerShell Add Folder  -  "02_-_Inputs"         -  Then 
    ;                                   PowerShell Add Folder  -  "03_-_Iterations"     -  Then
    ;                                   PowerShell Add Folder  -  "04_-_Final-Version"  -  Then
    ; Version 1.6.4 | 29-May-2025 | Added new Launch - PNG To PDF Converter Utility Python Script
    ; Version 1.6.5 | 17-Jun-2025 | Updated all python script paths to new systems path name convention updates.
    ; Version 1.6.6 | 18-Jun-2025 | Added Stable Diffusion ComfyUI launch command hotstrings for PowerShell execution.
    ; Version 1.6.7 | 25-Jun-2025 | Added new Launch Dir - PDF Document Compiler Utility Python Script
    ; Version 1.6.8 | 25-Jun-2025 | Added Copy WebDev__DownloadAllImages__ImageOver250px.js to clipboard and paste to current selection i.e. console in browser etc.
    ; Version 1.6.9 | 25-Jun-2025 | Added Copy WinUtil__PowerShell__CreateFilesFromList To Clipboard and Paste to current selection, allowing to
    ; Version 1.7.0 | 26-Jun-2025 | Added Markdown Hotstrings for creating new markdown files with title and strapline.
    ; Version 1.7.1 | 05-Aug-2025 | Updated Markdown template to include "Markdown Testing Document Utility" with structured content and bullet points.
    ; Version 1.7.2 | 05-Aug-2025 | Added Markdown Core Insight Section Template with HTML/CSS styling and SVG icon for enhanced visual presentation.
    ; Version 1.7.6 | 28-Aug-2025 | Added new Launch Dir - Project Architecture Mapper Utility Python Script
    ; Version 1.7.7 | 29-Aug-2025 | Added new Launch - Project File Tree Viewer Utility Python Script
    ; Version 1.8.0 | 19-Sep-2025 | Centralized Python scripts root directory and updated all paths to use relative navigation
    ; - Added PYTHON_ROOT variable as single source of truth for Python script locations
    ; - Updated all Python script hotstrings to use relative paths from 02_Python root
    ; - Updated script paths to match new directory structure and naming conventions
    ; - Added PNG To Timelapse Video Converter section with comprehensive hotstring patterns
    ; Version 1.8.5 | 07-Oct-2025 | Added new Launch - HTML To PDF Converter Utility Python Script
    ; - Added comprehensive hotstring patterns for HTML to PDF conversion (;html2pdf, ;py-html-to-pdf, etc.)
    ; - Supports pageless PDF generation with automatic height adjustment
    ; - Integrated with locally bundled dependencies system
...
#If
; |--------------------------------------------------------------------------------------------------------------------------------|
; region | - - - - - - - - - -  |  Markdown File Related Hotstrings  | - - - - - - - - - - - - - - - - - - - - - - - - |

    ; region  - |  Markdown Title & Strapline Template  | - 
    ; Added - 26-Jun-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below create a markdown file header with title and strapline.
    ; - Includes today's date automatically in the strapline.
    ; - Provides consistent formatting for new markdown files.
    ; - Cursor is positioned after the title for easy editing.
    ...
    ::;mdfileheading::
        {
            ...
            FormatTime, TodayDate, %A_Now%, dd-MMM-yyyy
            
            ; Create the markdown header template
            markdown_header := ""
            . "# Markdown Testing Document Utility`r`n"
            . "<div class=""h1__Strapline""> `r`n"
            . "Markdown Testing Document Utility - Started " . TodayDate . "`r`n"
            . "</div>"
            . "`r`n"
            . "`r`n"
            . "---`r`n"
            . "`r`n"
            . "### Document First Section`r`n"
            . "- Lorem ipsum dolor sit amet, consectetur adipiscing elit. `r`n"
            . "- Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. `r`n"
            . "- Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.`r`n"
            . "`r`n"
            . "---`r`n"
            . "`r`n"
            ...
            ; Set markdown header to clipboard
            Clipboard := markdown_header
    ...
    ; endregion  - |  Markdown Title & Strapline Template  | -

; |--------------------------------------------------------------------------------------------------------------------------------|


; region  - |  Markdown - Core Insight Section Template  | - 
    ; Added - 05-Aug-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below create a markdown "Core Insight" section.
    ; - Html and Inline CSS.
    ; - SVG Icon.
    ...
    ::;mdcoreinsight::
        {
            ; Create The Core Insight Section Template ready to Copy & Paste into a markdown file.
            markdown_CoreInsight := ""
            . "<div style=""border: 1px solid #ccc; border-radius: 8px; padding: 16px; margin: 16px 0; font-family: 'Open Sans', sans-serif; background-color: #f9f9f9;"">`r`n"
            . "<h3 style=""display: flex; align-items: center; margin-top: 0;"">`r`n"
            . "  <img src=""https://www.svgrepo.com/download/437037/lightbulb.svg"" alt=""Lightbulb"" width=""24"" height=""24"" style=""margin-right: 00.75rem;"">`r`n"
            . "  Core Insight`r`n"
            . "</h3>`r`n"
            . "<p><strong>DINO</strong> Stands For <strong>DETR with Improved Noisy student Optimization</strong></p>`r`n"
            . "<ul>`r`n"
            . "  <li>It refers to  to a supervised learning approach originally developed by Facebook AI (now Meta AI)</li>`r`n"
            . "  <li>Used for training vision transformers (ViTs) without labelled data.</li>`r`n"
            . "  <li>It stands out for producing strong feature representations</li>`r`n"
            . "  <li>Useful for tasks like object detection, segmentation, and image retrieval.</li>`r`n"
            . "</ul>`r`n"
            . "</div>"
            ...
            ; Set markdown header to clipboard
            Clipboard := markdown_CoreInsight
    ...
    ; endregion  - |  Markdown Core Insight Section Template  | -
...
; region | - - - - - - - - - - - - - - - - - - |  File Path Shortcut Scripts  | - - - - - - - - - - - - - - - - - - - - - - - - - - - - - |
    ...
    ; region  - - - |  Temporary Directory Folder Path Quick Paste  | - - -
    ; NOTES 
    ; - This is the directory on my work office PC that I use to quickly save none project specific files to.
    ; - This folder serves as a default save location, and my aim is to clean this folder every week or so.
    ...
    ; - - Command Logic - - 
        Clipboard := "D:\99_Temp__TempFiles\" ; Set the text to the clipboard
        ClipWait, 0.2 ; Wait for the clipboard to update (optional, ensures text is set)
        Send ^v ; Send the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; #region | ========================================= |  PYTHON SCRIPT PATH PASTING  | =========================================== |

; =============================================================================
; PYTHON SCRIPTS ROOT DIRECTORY - SINGLE SOURCE OF TRUTH
; =============================================================================
; NOTE: PYTHON_ROOT is now set globally as a constant at the very beginning 
; of this script (line 13) to ensure it's available throughout the entire 
; script execution before any return statements.
; All Python script references use relative paths from this root directory
; =============================================================================


; region | - - - - - - - - - - - - - - - |  Python Script Powershell Execution  | - - - - - - - - - - - - - - - -  - - - - |

    ; region  - - - |  Launch - PDF To PNG Converter Utility Python Script  | - - -
    ; Added - 09-May-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ; - This method is much faster than typing the full path of the script into the PowerShell environment.
    ; - Note To Self: This is a pottential approach to build more simple CLI scripts for future use, as admin access is not required.
    ...
    ::;py-conv-pdf-to-png::
    ::;py-convert-pdf2png::
    ::;py-convert-pdf-to-png::

    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\20__Python__PDFTools\Py_PdfUtils__PdfToPngConverter\Py_PdfUtils__PdfToPngConverter__Main__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                 				  ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                      				  ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; region | - - - - - - - - - - - - - - - |  Python Script Powershell Execution  | - - - - - - - - - - - - - - - -  - - - - |
    ...
    ; region  - - - |  Launch - PNG To PDF Converter Utility Python Script  | - - -
    ; Added - 11-Jun-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ::;py-conv-png-to-pdf::
    ::;py-convert-png2pdf::
    ::;py-convert-png-to-pdf::

    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\20__Python__PDFTools\Py_PdfUtils__PngToPdfConverter\Py_PdfUtils__PngToPdfConverter__Main__.py"  ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                 				 ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                       				 ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - HTML To PDF Converter Utility Python Script  | - - -
    ; Added - 07-Oct-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ; - This method is much faster than typing the full path of the script into the PowerShell environment.
    ; - Note To Self: This is a potential approach to build more simple CLI scripts for future use, as admin access is not required.
    ...
    ::;py-conv-html-to-pdf::
    ::;py-convert-html2pdf::
    ::;py-convert-html-to-pdf::

    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\20__Python__PDFTools\Py_PdfUtils__HtmlToPagelessPdfConverter\Py_PdfUtils__HtmlToPagelessPdfConverter__Main__.py"  ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                 				 ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                       				 ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - PDF Compression/Flattening Utility Python Script  | - - -
    ; Added - 15-Dec-2024
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ::;py-conv-pdfcompress::
    ::;py-conv-pdf-compress::
    ::;py-convert-pdfcompress::
    ::;py-convert-pdf-compress::

    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\20__Python__PDFTools\Py_PdfUtils__CompressPdfFile\Py_PdfUtils__CompressPdfFile__Main__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                 				 ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                       				 ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - PDF To DXF Converter Utility Python Script  | - - -
    ; Added - 18-Dec-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ::;py-conv-pdf-to-dxf::
    ::;py-convert-pdf2dxf::
    ::;py-convert-pdf-to-dxf::

    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\20__Python__PDFTools\Py_PdfUtils__PdfToDxfConverter\Py_PdfUtils__PdfToDxfConverter__Main__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                 				 ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                       				 ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - PNG To Timelapse Video Converter Utility Python Script  | - - -
    ; Added - 19-Sep-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ::;py-conv-png2video::
    ::;py-conv-png-to-video::
    ::;py-convert-png2video::
    ::;py-convert-png-to-video::

    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\50__Python__VideoTools\Py_VideoUtils__PngFilesToTimelapseVideo\Py_VideoUtils__PngFilesToTimelapseVideo__Main__.py"  ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                 				 ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                       				 ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; | - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - |
    ...
    ; region  - - - |  Launch - PDF Document Combiner Utility Python Script  | - - -
    ; Added - 22-May-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\20__Python__PDFTools\Py_PdfUtils__A3PdfDocCompiler\Py_PdfUtils__PdfDocCompiler__Main__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                                       ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                                             ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - Stable Diffusion ComfyUI Python Script  | - - -
    ; Added - 17-Jun-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to launch Stable Diffusion ComfyUI with the standard listen parameters.
    ; - This method is much faster than typing the full command into the PowerShell environment.
    ; - Note To Self: This assumes you are in the correct directory containing main.py
    ...
    ; - - Command Logic - - 
        Clipboard := "python main.py --listen --port 8188"   ; <-- This sets the command to the clipboard.
        ClipWait, 0.2                                        ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                               ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - Project File Tree Viewer Utility Python Script  | - - -
    ; Added - 29-Jan-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\10__Python__WinFileSystemTools\Py_WinUtil__ProjectFileTreeViewer\Py_WinUtil__ProjectFileTreeViewer__Main__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                                                                        ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                                                                              ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - File System Logger - List Files in Current Folder Utility Python Script  | - - -
    ; Added - 20-Sep-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\10__Python__WinFileSystemTools\Py_FileUtils__SimpleFileLogger__ListItems__InCurrentFolder\Py_FileUtils__SimpleFileLogger__ListFilesInCurrentFolder__DumpTxt__Main__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                                                                                                                                                                    ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                                                                                                                                                                          ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - File System Logger - List Folders at Current Directory Level Utility Python Script  | - - -
    ; Added - 20-Sep-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\10__Python__WinFileSystemTools\Py_FileUtils__SimpleFileLogger__ListItems__InCurrentFolder\Py_FileUtils__SimpleFileLogger__ListFoldersAtCurrentDirLevel__DumpTxt__Main__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                                                                                                                                                                     ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                                                                                                                                                                           ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - File Compression - Standard Archival Script (Main) Utility Python Script  | - - -
    ; Added - 20-Sep-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ; - - Command Hotstrings - - 
    ::;Archive__ZipFiles::
    ::;Archive__CompressFiles::
    ::;Archive__ArchiveFiles::
    ::;Archive__CreateArchive::
    ...
    ::;Python__ZipFiles::
    ::;Python__CompressFiles::
    ::;Python__ArchiveFiles::
    ::;Python__CreateArchive::

    ::;ArchiveZipFiles::
    ::;ArchiveCompressFiles::
    ::;ArchiveArchiveFiles::
    ...
    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\10__Python__WinFileSystemTools\Py_FileUtils__FileCompression__StandardArchivalScript\Py_FileUtils__FileCompression__StandardArchivalScript__Main__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                                                                                                                               ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                                                                                                                                     ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; |------------------------------------------------------------------------------------------------------------------------|
    ...
    ; region  - - - |  Launch - File Compression - Standard Archival Script (Unzip) Utility Python Script  | - - -
    ; Added - 20-Sep-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste. 
    ; - This is effectively a shortcut to open the Python script in the PowerShell environment.
    ...
    ; - - Command Hotstrings - - 
    ::;Archive__UnzipFiles::
    ::;Archive__ExtractFiles::
    ::;Archive__DecompressFiles::
    ::;Archive__ExtractArchive::
    ...
    ::;Python__UnzipFiles::
    ::;Python__ExtractFiles::
    ::;Python__DecompressFiles::
    ::;Python__ExtractArchive::

    ::;ArchiveUnzipFiles::
    ::;ArchiveExtractFiles::
    ::;ArchiveDecompressFiles::
    ::;ArchiveExtractArchive::
    ...
    ::;PythonUnzipFiles::
    ::;PythonExtractFiles::
    ::;PythonDecompressFiles::
    ::;PythonExtractArchive::
    ::;extract-files::

    ; - - Command Logic - - 
        Clipboard := "Python " . PYTHON_ROOT . "\10__Python__WinFileSystemTools\Py_FileUtils__FileCompression__StandardArchivalScript\Py_FileUtils__FileCompression__StandardArchivalScript__Unzip__.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                                                                                                                                                 ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                                                                                                                                       ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
    ...
    ::;template - sketchup::
        {
            ...
            sketchup_script := ""
            . "$sourcePath = ""D:\02_CoreLib__SketchUp\06__CoreLib__SketchUp__FileTemplates\SketchUp__MasterTemplate__Active.skp""`r`n"
            . "$destinationPath = ""Template__NewSketchUpFile.skp""`r`n"
            . "`r`n"
...
; region     |  - - - - - - - - - - - - - - - - - - |  PowerShell Image Folder Creation  | - - - - - - - - - - - - - - - - - - - - - - - - - - - |

    ; region  - |  Create Image Processing Folder Structure  | -
    ; Added - 04-Jun-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed into PowerShell auto type using clipboard add and paste.
    ; - This creates the standard folder structure for image processing projects as specified in version 1.6.3.
    ; - Creates four folders: "01_-_Reference", "02_-_Inputs", "03_-_Iterations", "04_-_Final-Version"
    ; - This method is much faster than manually creating folders and ensures consistency.
    ...
    ::;create-img-folders::
        {
            ; Store the PowerShell script content
            image_folders_script := ""
            . "Write-Host ""Creating image processing folder structure...""`r`n"
            . "`r`n"
            . "try {`r`n"
            . "    New-Item -ItemType Directory -Name ""01_-_Reference"" -Force | Out-Null`r`n"
            . "    Write-Host ""Created: 01_-_Reference""`r`n"
            . "`r`n"
            . "    New-Item -ItemType Directory -Name ""02_-_Inputs"" -Force | Out-Null`r`n"
            . "    Write-Host ""Created: 02_-_Inputs""`r`n"
            . "`r`n"
            . "    New-Item -ItemType Directory -Name ""03_-_Iterations"" -Force | Out-Null`r`n"
            . "    Write-Host ""Created: 03_-_Iterations""`r`n"
            . "`r`n"
            . "    New-Item -ItemType Directory -Name ""04_-_Final-Version"" -Force | Out-Null`r`n"
            . "    Write-Host ""Created: 04_-_Final-Version""`r`n"
            . "`r`n"
            . "    Write-Host ""Image processing folder structure created successfully!""`r`n"
            . "} catch {`r`n"
            . "    Write-Host ""Failed to create folder structure: $_""`r`n"
            . "}`r`n"
            . "`r`n"
            . "Read-Host -Prompt ""Press Enter to exit"""
            ...
            ; Set PowerShell script to clipboard
            Clipboard := image_folders_script
    ...
    ; endregion  - |  Create Image Processing Folder Structure  | -

; endregion     |  - - - - - - - - - - - - - - - - - |  END OF PowerShell Image Folder Creation  | - - - - - - - - - - - - - - - - - - - - - - - |


; |------------------------------------------------------------------------------------------------------------------------|

; region | - - - - - - - - - - - - - - - - - - |  PowerShell File Creation Utilities  | - - - - - - - - - - - - - - - - - - - - - - - - - - - - - |

    ; region  - - - |  Copy PowerShell Create Files From List Script  | - - -
    ; Added - 25-Jun-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed will read the contents of a PowerShell script to the clipboard and then paste it.
    ; - This script creates a list of files in the current directory from a predefined array.
    ; - This is useful for quickly setting up project structures or creating template files.
    ; - The script can be modified before execution to customize the file names as needed.
    ...
    {
        ; Set the file path
        FilePath := "D:\10_CoreLib__ValeCodebase\Root_GeneralDeveloperTools\20_PowerShell__WindowsUtilities\WinUtil__PowerShell__CreateFilesFromList.ps1"
        ; Check if the file exists
        If !FileExist(FilePath)
        { 
            ; Stops further execution if file is not found
        ...
        ; Send Ctrl+V to paste clipboard content wherever the cursor is located
        Send ^v
        return
    }
    ; - - Command Completed - - 
...
; region | - - - - - - - - - - - - - - - - - - |  JavaScript Web-Dev Snippets  | - - - - - - - - - - - - - - - - - - - - - - - - - - - - - |

    ; region  - - - |  Launch - WebDev :: Download All Images On Page (Over 250px)  | - - -
    ; Added - 25-Jun-2025
    ; COMMAND NOTES 
    ; - The Hotstrings below when typed will read the contents of a .js file to the clipboard and then paste it.
    ; - This is intended to be pasted into the browser's developer console to execute the script.
    ; - The script will download all images on a webpage that are larger than 250px in either width or height.
    ...
    {
        ; Set the file path
        FilePath := "D:\10_CoreLib__ValeCodebase\Root_GeneralDeveloperTools\03_JavaScript\WebDev__DownloadAllImages__ImageOver250px.js"
        ; Check if the file exists
        If !FileExist(FilePath)
        { 
            ; Stops further execution if file is not found
        ...
        ; Wait 500 milliseconds to ensure the clipboard is ready
        Sleep, 500
        
        ; Send Ctrl+Shift+V to paste clipboard content into Edge dev tools
        Send ^+v
        return
    }
    ; - - Command Completed - - 
...
; region | - - - - - - - - - - - - - - - - - - |  Clean Path Copy (Remove Quotes)  | - - - - - - - - - - - - - - - - - - - - - - - - - - |
; - Tested 02-May-2025; Works excellently 

; Intercept Ctrl+Shift+C when in Windows Explorer
#If WinActive("ahk_class CabinetWClass") || WinActive("ahk_class ExplorerWClass")

^+c::
    ; First, send the original Ctrl+Shift+C to let Windows perform the path copy
    SendInput, ^+c
    
    ; Wait briefly for Windows to process the copy operation
    Sleep, 100
    
    ; Check if clipboard contains text that looks like a quoted path
    if (RegExMatch(Clipboard, "^"".*""$")) {
        ; Save original clipboard content
        ClipboardOld := ClipboardAll
        
        ; Remove the first and last character (the quotes)
        CleanPath := SubStr(Clipboard, 2, StrLen(Clipboard) - 2)
        
        ; Replace the clipboard with the clean path
        Clipboard := CleanPath
        
        ; Add a brief tooltip to indicate the quotes were removed
        ToolTip, Path quotes removed, %A_CaretX%, %A_CaretY%
...
; region       |  - - - - - - - - - - - - - - - - - - - - - -  |  Links  | - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  |
    ...
    ; region  - |  Whitecardopedia Application Name  | - 
        ::;wcp::
        ::;whitecardp::
        ::;whitecp::
            {
                SendInput, Whitecardopedia
                return
            }
    ; endregion  - |  Whitecardopedia Application Name  | - 
