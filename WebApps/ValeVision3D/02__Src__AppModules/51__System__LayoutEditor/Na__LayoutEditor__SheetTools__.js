...
// -----------------------------------------------------------------------------
    ...
    function Na__LeTools__MenuItems(sheet, found, pointMm) {
        ...
        return [
            ...
            { separator : true }
        ].concat(locked ? [] : style(found.kind, found.id, { palette : false }), Na__LeClip__MenuItems(sheet, viewport, pointMm), [           // <-- Copy, duplicate and paste viewport
            { separator : true },
