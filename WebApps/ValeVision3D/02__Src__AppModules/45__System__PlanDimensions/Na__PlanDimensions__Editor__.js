// =============================================================================
// VALEVISION3D - PLAN DIMENSIONS - PLACEMENT AND EDITING
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 02__Src__AppModules/44__System__PlanDimensions/Na__PlanDimensions__Editor__.js
// - Source version: 1.0.0 (31-Aug-2026)
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.18.0 (port Phase 2)
// - Parity        : adapted (split)
// - Divergences   :
//   - The rubber-band preview nodes moved to Na__PlanDimensions__EditorPreview__.js; placement, selection and drag logic are unchanged.
//   - Focus arbiter imported from 42__System__DrawingViewCore (relocated module, Na__DrawFocus__ namespace).
...
// - Split: rubber-band preview moved to Na__PlanDimensions__EditorPreview__.js.
//
...
// -----------------------------------------------------------------------------
    ...
    // MODULE IMPORTS | Rubber-Band Preview (split out to keep this file in budget)
    // ------------------------------------------------------------
    // @delegate: ./Na__PlanDimensions__EditorPreview__.js
    // ------------------------------------------------------------
    import {
        Na__PlanDimPreview__Clear,
        Na__PlanDimPreview__Draw
    } from './Na__PlanDimensions__EditorPreview__.js';
    // ------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    function Na__PlanDimEdit__HandleCanvasPointerMove(event) {
        ...
        Na__PlanDimPreview__Draw(startPx, endPx, span.lengthMm);
    }
    // ------------------------------------------------------------
