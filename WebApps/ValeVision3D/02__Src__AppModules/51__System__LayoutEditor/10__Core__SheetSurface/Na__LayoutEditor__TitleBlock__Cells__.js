// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - TITLE BLOCK CELLS
// =============================================================================
//
...
//
// DESCRIPTION:
// - The strip used to be cut into relative shares, so every cell grew and
//   shrank with the paper: on an A2 sheet the Client cell was 76 mm for a
//   surname and the Drawing No. 49 mm for eight characters, while on A3 the
//   Drawing Title - the one value that is ever long - had 71 mm and cut an
//   88 mm title short. Adam, of the same strip in TrueVision, 19-Sep-2026:
//   "there are certain fields that are never going to need more size, so they
//   kind of seem needlessly oversized... The one thing that does need the
//   space is the drawing name."
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 10__Core__SheetSurface/Na__LayoutEditor__TitleBlock__Cells__.js,
//                   its 1.1.0 (the v2.79.0 module with the narrow-strip fix of the next day)
// - Ported on     : 20-Sep-2026
// - Parity        : verbatim - every code region is byte for byte TrueVision's
// - Divergences   : Header and the worked numbers in the description only, which
//                   are this app's strip (a Drawing No. cell, a 34 mm logo cell).
...
// - Ported from TrueVision3D's Cells 1.1.0. That is its v2.79.0 module plus the
//   fix made while this port was under way: on a strip too narrow even for the
//   text, the Flex cells are cut first, down to their labels, and the lot is
//   scaled only if that is not enough. TrueVision's 1.0.0 scaled every value
//   together at that point; this app never shipped that version.
//
// =============================================================================
