// =============================================================================
// VALEVISION3D - NORTH DIRECTION - PICK TOOL
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 46__System__NorthDirection/Na__North__PickTool__.js,
...
// -----------------------------------------------------------------------------
    ...
    function Na__NorthPick__Initialize(context) {
        if (!context || !context.renderer || !context.camera) {
            console.warn('[ValeVision3D] North direction pick init skipped - missing renderer or camera.');
            return false;
        }
