// =============================================================================
// VALEVISION3D - ELEVATION VIEWS - FACE PICK
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : ValeVision3D 40__System__2dElevationsView/Na__ElevationView__SystemLogic.js (face selection rules only)
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.19.0 (port Phase 3)
// - Parity        : new (TrueVision has no face pick by design; see its PlaneGizmo header)
// - Divergences   : n/a
// - Back-port     : candidate.
//
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    function Na__ElevPick__Initialize(context) {
        if (!context || !context.renderer || !context.camera) {
            console.warn('[ValeVision3D] Elevation face pick init skipped - missing renderer or camera.');
            return false;
        }
