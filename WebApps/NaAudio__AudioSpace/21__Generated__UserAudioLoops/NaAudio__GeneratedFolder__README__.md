# 21__Generated__UserAudioLoops

**Empty on purpose. Nothing writes here yet.**

This folder is where loops the user imports will live once AudioSPACE has a server behind it. It mirrors
`06__Data__AudioLoopLibrary`, which holds the shipped, version-controlled equivalent.
