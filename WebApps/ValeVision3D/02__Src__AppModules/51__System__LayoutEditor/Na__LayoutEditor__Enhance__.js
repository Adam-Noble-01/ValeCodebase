...
//
// PORT NOTE:
// - Ported from   : ValeVision3D 30__System__ImageExport/Na__ImageExport__PostProcessEffects__Pipeline.js (the stack)
// - Ported on     : 10-Sep-2026 for ValeVision3D v2.21.8 (port Phase 5)
// - Parity        : adapted
// - Divergences   : fixed two-effect order, parameters from the Layout Editor config, no progress reporting.
// - Back-port     : none.
//
// -----------------------------------------------------------------------------
//
