// =============================================================================
// VALEVISION3D - FLOOR PLAN VIEWS - SCENE LINK
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 02__Src__AppModules/42__System__FloorPlanViews/Na__FloorPlan__SceneLink__.js
...
// -----------------------------------------------------------------------------
    ...
    function Na__FpLink__EnsureGroupsExist(sceneConfig) {
        ...
        console.log('[ValeVision3D] Seeded the default scene groups so the new floor plan has somewhere to live.');
    ...
    function Na__FpLink__ResolveTargetGroupId(sceneConfig) {
        ...
        if (matched[Na__FpLink__GROUP_ENABLED] === false && target.autoEnable) {
            ...
            console.log('[ValeVision3D] Enabled the "' + matched[Na__FpLink__GROUP_NAME] + '" scene group for the new floor plan.');
        }
