// =============================================================================
// VALEVISION3D - PROJECTED LINEWORK - SVG OVERLAY
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : Lantern Designer 02__Src__AppModules/27__System__ProjectedEdges2d/VghLantern__ProjectedEdges__SvgLayer__.mjs
// - Source version: Lantern Designer rebuild of 07-Aug-2026
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.20.0 (port Phase 4)
// - Parity        : adapted
// - Divergences   :
//   - A standalone SVG over the WebGL canvas instead of a group inside an Env2d viewport; registered per frame from the ortho camera.
//   - Four line classes as presentation attributes; hidden class dashed.
//   - Markup export for the image compositor.
