// =============================================================================
// VALEVISION3D - ELEVATION VIEWS - GIZMO GRIP
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : ValeVision3D 41__System__CrossSectionView/Na__CrossSectionView__SystemLogic.js (axis drag maths)
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.19.0 (port Phase 3)
// - Parity        : new (TrueVision keeps its gizmo read-only by design)
// - Divergences   : n/a
// - Back-port     : candidate.
//
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    function Na__ElevGrip__Initialize(context) {
        if (!context || !context.renderer || !context.camera) {
            console.warn('[ValeVision3D] Elevation gizmo grip init skipped - missing renderer or camera.');
            return false;
        }
