...
// - Parity        : extended
// - Divergences   : LD is a desktop surface and binds no touch gestures at all. The pinch, the two finger pan, the stage pan and the double tap fit are new here.
// - Back-port     : the whole module is worth taking back to LD if the drawing editor is ever used on a tablet.
//
// -----------------------------------------------------------------------------
//
// DEVELOPMENT LOG:
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    import { Na__LeCfg__GetGuards, Na__LeCfg__GetTouchSetup } from '../03__Core__Config/Na__LayoutEditor__ConfigState__.js';
    import {
