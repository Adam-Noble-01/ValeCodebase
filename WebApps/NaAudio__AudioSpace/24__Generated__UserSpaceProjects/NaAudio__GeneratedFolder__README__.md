...
This folder is where spaces the user saves will live once AudioSPACE has a server behind it. It mirrors
`09__Data__PatchLibrary/30__Patches__SpaceScene`, which holds the shipped, version-controlled equivalent.
