// =============================================================================
// VALEVISION3D - DRAWING VIEW CORE - ACTIVE VIEW BROKER
// =============================================================================
//
...
//
// DESCRIPTION:
// - ValeVision now has TWO kinds of 2D drawing - a floor plan looking down and
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 02__Src__AppModules/40__System__DrawingViewCore/Na__DrawView__ActiveView__.js
    ...
    function Na__DrawView__IsValidAdapter(adapter) {
        ...
        for (let i = 0; i < Na__DrawView__REQUIRED_FNS.length; i++) {
            ...
            if (typeof adapter[name] !== 'function') {
                console.warn('[ValeVision3D] Drawing view adapter is missing ' + name + ' - not installed.');
                return false;
            }
        }
        return true;
