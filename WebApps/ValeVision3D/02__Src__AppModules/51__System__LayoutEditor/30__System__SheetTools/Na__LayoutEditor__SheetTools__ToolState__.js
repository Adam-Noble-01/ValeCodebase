// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SHEET TOOLS - TOOL STATE
// =============================================================================
//
...
//   (CancelPlacement, which also empties the eyedropper, cancels a selection
//   box and drops a half-typed Measurements value), sets the stage's resting
//   cursor (ToolCursor) and announces CHANGED_EVENT. Draw or Rectangle,
//   whichever was picked last, is remembered for a vector palette sync.
...
// -----------------------------------------------------------------------------
    ...
    // MODULE IMPORTS | Config, Model, Placing Tools, Gradient and Dash, Measurements, Eyedropper, Axis Lock, Selection Box
    // ------------------------------------------------------------
    import {
    ...
    import { Na__LeDash__Defaults, Na__LeDash__Create } from '../35__System__DrawingTools/Na__LayoutEditor__LineStyleTool__.js';   // @delegate: ../35__System__DrawingTools/Na__LayoutEditor__LineStyleTool__.js
...
// -----------------------------------------------------------------------------
    ...
    function Na__LeTools__GetDimensionDefaults() {
        if (!Na__LeTools__DimDefaults) {
            ...
            Na__LeTools__DimDefaults = { textSizeMm : s.defaultTextSizeMm, colour : s.defaultColour, terminator : s.defaultTerminator, tickLengthMm : s.tickLengthMm, offsetMm : s.defaultOffsetMm, precision : s.defaultPrecision, unitsSuffix : s.defaultUnits,
                                         atScale : true };                   // <-- DrawingScale for the Measurements box; no Dimensions panel toggle row here
        }
    ...
    function Na__LeTools__CancelPlacement() {
        ...
        Na__LeTools__WriteDimEndRetype(null);                                // <-- And a dimension whose span or offset could still be retyped
