// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SHAPE GEOMETRY
// =============================================================================
//
...
// - Shape__LineStyle reaches the primitive as dashArray, so dashed, dotted
//   and dash-dot (centre) edges paint through the chrome. A record from
//   before the toggle has no line style and stays a solid edge.
// - Ported from TrueVision3D (ShapeGeometry dashed edges).
//
// 14-Sep-2026 - Version 1.4.0
// - ClosestOnEdge and InsertPoint: the nearest foot on any edge, and a vertex
//   spliced in after that edge's start, for Shift-click insert.
...
//   area, alpha end included. Ported from TrueVision.
//
...
// -----------------------------------------------------------------------------
    ...
    import { Na__LeDash__PatternMm } from '../35__System__DrawingTools/Na__LayoutEditor__LineStyleTool__.js';   // @delegate: ../35__System__DrawingTools/Na__LayoutEditor__LineStyleTool__.js
    // ------------------------------------------------------------
