// =============================================================================
// VALEVISION3D - TEST - NORTH DIRECTION - COMPASS MATHS
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 80__Testing__PrototypeEnvironment/Na__Test__NorthCompass__.test.mjs
...
// -----------------------------------------------------------------------------
    ...
    console.log('ValeVision3D - north direction compass maths');
