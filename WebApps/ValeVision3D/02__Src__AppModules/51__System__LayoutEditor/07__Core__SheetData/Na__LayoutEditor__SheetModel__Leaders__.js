// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SHEET MODEL - LEADERS
// =============================================================================
//
...
// - GetLeaderById and InsertLeader, ported from TrueVision3D: a paste of a
//   leader, the way InsertShape and InsertAnnotation paste a vector or a
//   text item - a complete record, deep-copied, given a fresh id. Read by
//   Na__LayoutEditor__ItemClipboard__, which now copies, pastes and
//   duplicates a leader the way it already does text.
//
