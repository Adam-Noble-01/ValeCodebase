// =============================================================================
// VALEVISION3D - PROJECTED LINEWORK - DIFF HARNESS
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : Lantern Designer 02__Src__AppModules/27__System__ProjectedEdges2d/VghLantern__ProjectedEdges__DiffHarness__.mjs
...
// -----------------------------------------------------------------------------
    ...
    export function Na__ProjectedLinework__DiffHarness__LogReport(report) {
        ...
        console.log(
            '[ValeVision3D ProjectedLinework] ' + report.NameA + ' vs ' + report.NameB + ': ' + headline
        );
        ...
        if (report.LengthDrift < 1e-6) {
            console.log('[ValeVision3D ProjectedLinework] Total length agrees to ' + driftPercent +
                        ' percent - the differences are rounding, not lost detail.');
        } else {
            console.warn('[ValeVision3D ProjectedLinework] Total length differs by ' + driftPercent +
