...
; region | - - - - - - - - - - - - - - - - - - |  File Path Shortcut Scripts  | - - - - - - - - - - - - - - - - - - - - - - - - - - - - - |
    ...
    ; - - Command Logic - - 
        Clipboard := "D:\80_-_Core-Lib_-_Temp-Files\" ; Set the text to the clipboard
        ClipWait, 0.2 ; Wait for the clipboard to update (optional, ensures text is set)
        Send ^v ; Send the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
...
; region | - - - - - - - - - - - - - - - |  Python Script Powershell Execution  | - - - - - - - - - - - - - - - -  - - - - |
    ...
    ; - - Command Logic - - 
        Clipboard := "Python C:\03_-_Adam-Noble-Tools\02_-_Python\SnPy_PdfToPngConverter\SnPy_PdfToPngConverter.py"   ; <-- This sets the text appended to the clipboard.
...
; | - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - |
    ...
    ; - - Command Logic - - 
        Clipboard := "Python C:\03_-_Adam-Noble-Tools\02_-_Python\SnPy_PdfDocCompiler\SnPy_PdfDocCompiler.py"   ; <-- This sets the text appended to the clipboard.
        ClipWait, 0.2                                                                                             ; <-- Wait for the clipboard to update, this ensures text is set.
        Send ^v                                                                                                   ; <-- This Sends the paste command (Ctrl+V)
    return
    ; - - Command Completed - - 
