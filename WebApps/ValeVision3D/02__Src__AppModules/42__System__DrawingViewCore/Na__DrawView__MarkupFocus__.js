// =============================================================================
// VALEVISION3D - DRAWING VIEW CORE - MARKUP FOCUS ARBITER
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 02__Src__AppModules/42__System__FloorPlanViews/Na__FloorPlan__MarkupFocus__.js
// - Source version: 1.1.0 (31-Aug-2026)
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.18.0 (port Phase 2)
// - Parity        : verbatim (relocated)
// - Divergences   :
...
//   - Relocated from the floor plan folder so the annotation and dimension systems never import from 43; identifiers renamed Na__FpFocus__ to Na__DrawFocus__.
...
// -----------------------------------------------------------------------------
    ...
    function Na__DrawFocus__CanAct(owner, capability) {
        ...
        try {
            ...
            console.warn('[ValeVision3D] Markup focus probe failed for ' + owner + '.' + capability, error);
            return false;
        }
    }
    // ------------------------------------------------------------
