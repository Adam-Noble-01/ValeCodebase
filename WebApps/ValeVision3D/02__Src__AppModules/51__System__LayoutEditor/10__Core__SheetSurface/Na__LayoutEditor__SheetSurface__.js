...
//
// PORT NOTE:
// - Ported from   : Lantern Designer 30__System__DrawingEditorMode/VghLantern__DrawingEditor__SheetSurface__.js
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.21.0 (port Phase 5)
// - Parity        : adapted
// - Divergences   : free viewport frames instead of a view grid; selection layer; per-frame content delegated to the viewport modules.
// - Back-port     : none.
//
// -----------------------------------------------------------------------------
//
...
//   parked (a raster level, a scene edit) re-renders exactly the viewports it
//   touches, then. Force Render is untouched.
...
// - Ported from TrueVision3D 1.6.0 (v2.64.0).
//
...
// - Box select: with several selected items the markup highlights every one,
//   and the selection layer outlines every selected viewport - without handles
//   or grips, which edit one item at a time (Na__LeHandles__RenderOutlines).
