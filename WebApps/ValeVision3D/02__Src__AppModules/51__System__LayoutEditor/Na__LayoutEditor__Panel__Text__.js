// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - PANEL: TEXT
// =============================================================================
//
...
// -----------------------------------------------------------------------------
    ...
    import { Na__LeText__WrapDeg, Na__LeText__RotationPatch } from './Na__LayoutEditor__TextTool__.js';
    import { Na__LeMarkup__AnnotationRotationDeg } from './Na__LayoutEditor__MarkupBridge__.js';
    import {
