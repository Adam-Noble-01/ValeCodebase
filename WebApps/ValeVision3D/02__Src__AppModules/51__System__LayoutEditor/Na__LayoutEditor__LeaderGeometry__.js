// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - LEADER GEOMETRY
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 51__System__LayoutEditor/Na__LayoutEditor__LeaderGeometry__.js 1.0.0
// - Ported on     : 14-Sep-2026
// - Parity        : verbatim (header only)
// - Divergences   : none - pure geometry; both apps lay out and draw a Sheet__Leaders record alike
...
// -----------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    import { Na__LeCfg__GetLeaderSetup, Na__LeCfg__GetTextSetup, Na__LeCfg__PtToMm } from './Na__LayoutEditor__ConfigState__.js';
    import { Na__LeChrome__MeasureTextMm, Na__LeChrome__PushPolyline, Na__LeChrome__PushText } from './Na__LayoutEditor__SheetChrome__.js';
    // ------------------------------------------------------------
