// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - PANEL: DIMENSIONS
// =============================================================================
//
...
// PURPOSE    : Text size, colour, terminator, terminator size, offset, precision, units and override for the selected dimension, or for new ones
// CREATED    : 09-Sep-2026
//
// DESCRIPTION:
...
//
// PORT NOTE:
// - Ported from   : ValeVision3D 45__System__PlanDimensions (editor controls purpose)
