// =============================================================================
// VALEVISION3D - DRAWING VIEW CORE - STYLE ROWS
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : none (ValeVision original; TrueVision has no per-drawing styles)
// - Ported on     : 09-Sep-2026 for ValeVision3D v2.19.0 (port Phase 3)
// - Parity        : new
// - Divergences   : n/a
// - Back-port     : candidate when TrueVision gains per-drawing styles.
//
// -----------------------------------------------------------------------------
//
// DEVELOPMENT LOG:
