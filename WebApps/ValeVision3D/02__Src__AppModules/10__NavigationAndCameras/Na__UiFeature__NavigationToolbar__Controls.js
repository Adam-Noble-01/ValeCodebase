...
//
// DEVELOPMENT LOG:
// 16-Sep-2026 - Views Button Retired
// - Removed the Views button (it shared the Reset View icon and only toggled
//   the scene carousel, which now always shows itself whenever a project has
//   valid saved scenes — see Na__PresentationMode__UI__SceneCarousel.js). The
//   toolbar is narrower as a result, which lets the mobile menu swap's
//   collision breakpoint below be tightened.
//
// 16-Sep-2026 - Mobile Menu Swap
// - Button order: Orbit | Walk | Fly | Reset View | Help | [Menu].
//   The Menu (hamburger) button is mobile-only (<=768px, CSS-gated): it swaps
//   the toolbar out for the Tools & Settings dropdown so the two no longer
//   render at once and overlap in portrait layouts. Ported from TrueVision3D
//   v2.9.0 (29-Aug-2026).
//
...
// -----------------------------------------------------------------------------
    ...
    // Ported from TrueVision3D v2.9.0 (29-Aug-2026).
    // ------------------------------------------------------------
