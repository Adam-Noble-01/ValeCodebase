// =============================================================================
// VALEVISION3D - PROJECTED LINEWORK - RASTER PREVIEW
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : Lantern Designer 02__Src__AppModules/27__System__ProjectedEdges2d/VghLantern__ProjectedEdges__RasterPreview__.mjs
...
// - Parity        : verbatim
// - Divergences   :
//   - Identifiers and console prefix only; the on-screen drawing does not use it (the composer render is the underlay) but the Layout Editor viewports may.
...
// -----------------------------------------------------------------------------
    ...
    function Na__ProjectedLinework__RasterPreview__Renderer__Ensure() {
        ...
        try {
            ...
            console.warn('[ValeVision3D ProjectedLinework] Preview renderer unavailable, drawings will simply wait for vectors:', createError);
...
// -----------------------------------------------------------------------------
    ...
    export function Na__ProjectedLinework__RasterPreview__Render(soup, edges, options) {
        ...
        try {
            ...
            console.warn('[ValeVision3D ProjectedLinework] Preview render failed:', renderError);
            dataUrl  =  null;
        } finally {
