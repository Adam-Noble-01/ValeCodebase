// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - PDF FILE NAMES
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 60__Feature__PdfExport/Na__LayoutEditor__PdfFilename__.js
// - Ported on     : 17-Sep-2026 for ValeVision3D v2.55.0
// - Parity        : verbatim
// - Divergences   : the app name in this header only.
...
// - Ported from TrueVision3D, where it was split out of the PDF exporter so the
//   specification download names its file the same way a sheet does.
//
// =============================================================================
