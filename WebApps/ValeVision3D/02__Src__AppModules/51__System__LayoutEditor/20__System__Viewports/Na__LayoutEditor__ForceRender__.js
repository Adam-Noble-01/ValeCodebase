// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - FORCE RENDER
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 51__System__LayoutEditor/Na__LayoutEditor__ForceRender__.js
...
// -----------------------------------------------------------------------------
    ...
    async function Na__LeForce__One(sheet, viewport) {
        ...
        try {
            ...
            console.warn('[ValeVision3D LayoutEditor] Forced render failed for ' + viewport.Viewport__Id + ':', error);
