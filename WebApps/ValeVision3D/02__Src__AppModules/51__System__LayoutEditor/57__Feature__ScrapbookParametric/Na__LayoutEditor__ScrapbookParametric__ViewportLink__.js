...
// -----------------------------------------------------------------------------
    ...
    function Na__LeParamLink__BeforeAnnounce(reason, sheetId) {
        ...
        if (adopting && !adopting.heard && sheetId === adopting.sheetId) {
            ...
            catch (error) { console.warn('[ValeVision3D LayoutEditor] A dropped parametric element could not be linked.', error); }
        ...
        try {
            ...
            console.warn('[ValeVision3D LayoutEditor] A linked parametric element could not follow its viewport.', error);
        } finally {
    ...
    function Na__LeParamLink__Refresh(sheet) {
        ...
        try {
            ...
            console.warn('[ValeVision3D LayoutEditor] Linked parametric elements could not be refreshed.', error);
            return 0;
        } finally {
            Na__LeParamLink__Following = false;
        }
