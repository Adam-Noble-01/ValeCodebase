// =============================================================================
// VALEVISION3D - LAYOUT EDITOR - SCRAPBOOK
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 55__Feature__Scrapbook/Na__LayoutEditor__Scrapbook__.js,
//                   its 1.1.0 (TrueVision v2.85.0)
// - Ported on     : 20-Sep-2026 for ValeVision3D v2.68.0
// - Parity        : adapted
// - Divergences   : This app has no site plan drawing type, so every sheet is an architectural one:
//                   ItemsFor filters by that constant where TrueVision asks the sheet model. THE
//                   LIBRARY ITSELF ARRIVES EMPTY - TrueVision's standard items are Noble
//                   Architecture's own site plan furniture (its OS licence block and north point)
//                   and have no place in this app. The module is here because every other library
//                   draws its tiles, its previews and its bounds through it.
...
// - Ported from TrueVision3D's 1.1.0.
//
// =============================================================================
        ...
        if (!Na__LeScrap__LoadPromise) {
            Na__LeScrap__LoadPromise = (async () => {
                try {
                    ...
                    console.warn('[ValeVision3D LayoutEditor] Scrapbook config unavailable - the Scrapbook has no items.', error);
