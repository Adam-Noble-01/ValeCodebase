// =============================================================================
// VALEVISION3D - PLAN ANNOTATIONS - EDITOR INTERACTION
// =============================================================================
//
...
//
// PORT NOTE:
// - Ported from   : TrueVision3D 02__Src__AppModules/43__System__PlanAnnotations/Na__PlanAnnotations__Editor__.js
...
// -----------------------------------------------------------------------------
    ...
    // @delegate: ../42__System__DrawingViewCore/Na__DrawView__Navigation__.js
    // ------------------------------------------------------------
    import { Na__DrawView__IsActive } from '../42__System__DrawingViewCore/Na__DrawView__ActiveView__.js';
    import { Na__DrawNav__SetSuppressed } from '../42__System__DrawingViewCore/Na__DrawView__Navigation__.js';
    import {
