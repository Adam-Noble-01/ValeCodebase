...
This folder is where instrument and effect patches the user saves will live once AudioSPACE has a server behind it. It mirrors
`09__Data__PatchLibrary`, which holds the shipped, version-controlled equivalent.
